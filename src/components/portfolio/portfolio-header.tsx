...
export function PortfolioHeader() {
  return (
    <section className="py-20 md:pt-32 md:pb-16 bg-gradient-to-b from-gray-900 to-black">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            <Link 
              href="/portfolio" 
              className="inline-flex items-center text-gray-400 hover:text-blue-400 transition-colors duration-200 group"
            >
          ...
          <div className="text-left md:text-center">
            <h1 className="text-3xl md:text-5xl font-bold mb-6 leading-tight text-white">Nossos Projetos</h1>
            <p className="text-lg text-gray-300 mb-10 max-w-3xl md:mx-auto leading-relaxed">
