...
// Define a more precise interface for the raw project data from your API
...
// Normalized project interface for your component
interface Projeto {
  id: string;
  title: string;
  description: string;
...
export default async function Portfolio() {
  // Type the raw projects as RawProjeto[]
  const rawProjects: RawProjeto[] = await getProjetos();
  
  // Safely map raw projects to normalized projects
