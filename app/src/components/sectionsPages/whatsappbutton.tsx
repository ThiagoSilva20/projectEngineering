...
export default function Whatsappbutton() {
  ...
  return (
    ...
    >
      {isTooltipVisible && (
        <div className="absolute bottom-full right-0 mb-3 p-4 bg-white rounded-lg shadow-lg max-w-xs animate-fade-in">
          <Button
            variant="ghost"
            size="icon"
          ...
          <p className="text-gray-600 text-sm">
            Estamos online para tirar suas dúvidas sobre nossos serviços de engenharia de fachadas.
          </p>
        </div>
      )}
